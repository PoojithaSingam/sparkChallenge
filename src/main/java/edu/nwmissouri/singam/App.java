...
public final class App {
  //  private App() {
    //}
    private static void apps(String fileName) {
      SparkConf sparkConf = new SparkConf().setMaster("local").setAppName("JD App Word Counter");
      ...
      output.saveAsTextFile("CountData");
